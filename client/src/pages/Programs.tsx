...
const programs = [
  ...
  },
  {
    ...
    description: "The signature RI Tennis Academy adult experience. The 105 Game is a structured group format where adults sign up and play competitive, coached sessions. This is the primary adult program Mario offers.",
    pricing: [{ label: "Per 1.5-hour session", price: "$30" }],
    highlights: [
      "Competitive group play format",
      "Coached matchplay",
      "Great for adult social players",
