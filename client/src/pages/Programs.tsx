...
const programs = [
  ...
  },
  {
    ...
    subtitle: "Morning 9 AM & Evening 6:30 PM · Mon · Wed · Fri",
    category: "adult",
    badge: "Most Popular",
    accentColor: "from-amber-500 to-orange-600",
    photo: `${CDN}/IMG_2867_fa17ab01.jpg`,
    photoAlt: "Adult player hitting backhand — 105 Game Clinic",
    description: "The signature RI Tennis Academy adult experience. The 105 Game is a structured group format where adults sign up and play competitive, coached sessions. Now available in TWO time slots — morning and evening!",
    pricing: [{ label: "Per 1.5-hour session", price: "$35" }],
    highlights: [
      "🌅 Morning: 9:00 – 10:30 AM (Mon, Wed, Fri & Sun)",
      "🌙 Evening: 6:30 – 8:00 PM (Mon, Wed & Fri)",
      "Competitive group play format",
      "Coached matchplay",
      "1.5 hours per session",
      "$35 per session — both time slots",
    ],
  ...
  },
  {
    ...
    subtitle: "Summer · 9 AM–2 PM (half-day) or 9 AM–5 PM (full day)",
    category: "junior",
    badge: "Juniors",
    ...
    description: "Summer junior program running 9 AM–2 PM daily. Half-day or full-day options. Weekly packages available for the best value.",
    pricing: [
      { label: "Half-Day (9 AM–2 PM)", price: "$99" },
      { label: "Full Day (9 AM–5 PM)", price: "$125" },
      { label: "Weekly Half-Day (5 days)", price: "$495" },
      { label: "Weekly Full Day (5 days)", price: "$625" },
    ],
    highlights: [
      "Summer program: 9 AM–2 PM daily",
      "Full day option: 9 AM–5 PM (+$26)",
  ...
  },
  {
    ...
    subtitle: "Tue & Thu 6:30–8 PM · Sat 9–11 AM",
    category: "doubles",
    badge: "New",
