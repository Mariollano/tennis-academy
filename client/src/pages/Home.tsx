  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden text-white min-h-[600px] flex items-center">
        ...
        {/* On mobile: smaller circles in a single row; on desktop: normal size */}
        <div className="absolute top-3 left-4 z-10 flex items-center gap-1.5 sm:gap-2" style={{ maxWidth: 'calc(100% - 200px)' }}>
          {[
