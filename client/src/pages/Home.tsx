  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden text-white min-h-[600px] flex items-center">
        ...
        {/* Social media icons - top left corner */}
        <div className="absolute top-4 left-4 z-10 flex items-center gap-3">
          <a href="https://www.youtube.com/@MarioRITennis" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-white/15 hover:bg-red-600/80 border border-white/30 text-white rounded-full px-3 py-1.5 text-xs font-semibold transition-all hover:scale-105">
          ...
          <a href="https://instagram.com/deletefearwithmario" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-white/15 hover:bg-pink-600/80 border border-white/30 text-white rounded-full px-3 py-1.5 text-xs font-semibold transition-all hover:scale-105">
          ...
          <a href="https://facebook.com/RITennisAcademy" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-white/15 hover:bg-blue-600/80 border border-white/30 text-white rounded-full px-3 py-1.5 text-xs font-semibold transition-all hover:scale-105">
