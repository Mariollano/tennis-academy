  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden text-white min-h-[600px] flex items-center">
        ...
        {/* Social media circles - top left corner */}
        <div className="absolute top-3 left-4 z-10 flex items-center gap-2">
          {[
            ...
            <a key={href} href={href} target="_blank" rel="noopener noreferrer"
              ...
              <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-white/60 shadow-lg">
              ...
              {/* Platform icon badge */}
              <div className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full flex items-center justify-center shadow-md border border-white"
