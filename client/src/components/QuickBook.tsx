...
const programs = [
  ...
  { label: "Private Clinic", href: "/programs", price: "Invite only · $35", icon: Users, color: "bg-rose-600" },
  { label: "Junior Program", href: "/book/junior_daily", price: "$99/day", icon: Star, color: "bg-green-600" },
