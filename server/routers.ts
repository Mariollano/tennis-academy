  ...
  return `
    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:13px;">
      ...
      <tbody>
        ...
        <tr style="background:#f9f9f9;"><td style="padding:8px 12px;border-bottom:1px solid #eee;">Junior Program – Daily</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 3:30–6:30 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$75 / day</td></tr>
        <tr><td style="padding:8px 12px;border-bottom:1px solid #eee;">Junior Program – Weekly</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 3:30–6:30 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$375 / week</td></tr>
...
- Programs: Private lessons ($125/hr, 1-on-1 with Coach Mario), Semi-private lessons ($15/person), 105 Game adult clinic ($35/session, 1.5hr), Junior programs (daily $75, weekly $375, 3:30-6:30 PM), Summer camp half-day (daily $99, weekly $495, 9AM-2PM), Summer camp full day (daily $125, weekly $625, 9AM-5PM, after camp add-on +$26/day), Doubles League ($15/session, Tue/Thu 6:30-8PM & Sat 9-11AM, all levels, unlimited players), Mental coaching (contact for pricing)
