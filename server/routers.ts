  ...
  return `
    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:13px;">
      ...
      <tbody>
        ...
        <tr style="background:#f9f9f9;"><td style="padding:8px 12px;border-bottom:1px solid #eee;">Junior Program – Half-Day Daily</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 9 AM–2 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$99 / day</td></tr>
        <tr><td style="padding:8px 12px;border-bottom:1px solid #eee;">Junior Program – Full Day Daily</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 9 AM–5 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$125 / day</td></tr>
        <tr style="background:#f9f9f9;"><td style="padding:8px 12px;border-bottom:1px solid #eee;">Junior Program – Weekly Half-Day</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 9 AM–2 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$495 / week</td></tr>
        <tr><td style="padding:8px 12px;border-bottom:1px solid #eee;">Junior Program – Weekly Full Day</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 9 AM–5 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$625 / week</td></tr>
        <tr style="background:#f9f9f9;"><td style="padding:8px 12px;border-bottom:1px solid #eee;">Summer Camp – Daily (half-day)</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 9 AM–2 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$99 / day</td></tr>
        <tr><td style="padding:8px 12px;border-bottom:1px solid #eee;">Summer Camp – Weekly (half-day)</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">Mon–Fri, 9 AM–2 PM</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">$495 / week</td></tr>
        <tr style="background:#f9f9f9;"><td style="padding:8px 12px;border-bottom:1px solid #eee;">After Camp add-on (2:30–5 PM)</td><td style="padding:8px 12px;border-bottom:1px solid #eee;">2:30–5 PM (add-on)</td><td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:right;">+$26/day ($125 full day)</td></tr>
    ...
    create: publicProcedure
      ...
      .mutation(async ({ ctx, input }) => {
        ...
        if (input.programType === "private_lesson" && input.sessionDate && input.sessionStartTime) {
          ...
          // Junior Program: weekdays 9 AM–5 PM (summer hours)
          if (isWeekday && overlaps(lessonStartMins, lessonEndMins, 9 * 60, 17 * 60)) {
...
- Programs: Private lessons ($125/hr, 1-on-1 with Coach Mario), Semi-private lessons ($15/person), 105 Game adult clinic ($35/session, 1.5hr), Junior summer program (half-day $99/day, full-day $125/day, weekly half-day $495, weekly full-day $625, 9AM-2PM or 9AM-5PM), Summer camp half-day (daily $99, weekly $495, 9AM-2PM), Summer camp full day (daily $125, weekly $625, 9AM-5PM, after camp add-on +$26/day), Doubles League ($15/session, Tue/Thu 6:30-8PM & Sat 9-11AM, all levels, unlimited players), Mental coaching (contact for pricing)
