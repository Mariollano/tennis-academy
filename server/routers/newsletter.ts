    ...
    ? `<tr><td style="padding:24px 32px 0;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:13px;">
          ...
          <tbody>
            ...
            <tr style="background:rgba(255,255,255,0.05);"><td style="padding:8px 12px;border-bottom:1px solid #253545;color:#F4F6F0;">Junior Program (half-day)</td><td style="padding:8px 12px;border-bottom:1px solid #253545;color:#8A9BAD;">Mon–Fri, 9 AM–2 PM</td><td style="padding:8px 12px;border-bottom:1px solid #253545;text-align:right;color:#F4F6F0;">$99/day · $495/wk</td></tr>
            <tr><td style="padding:8px 12px;border-bottom:1px solid #253545;color:#F4F6F0;">Junior Program (full day)</td><td style="padding:8px 12px;border-bottom:1px solid #253545;color:#8A9BAD;">Mon–Fri, 9 AM–5 PM</td><td style="padding:8px 12px;border-bottom:1px solid #253545;text-align:right;color:#F4F6F0;">$125/day · $625/wk</td></tr>
